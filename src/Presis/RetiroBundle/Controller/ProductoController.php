...
use Presis\RetiroBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PresisRetiroBundle:Producto')->findAll();

        return $this->render('PresisRetiroBundle:Producto:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PresisRetiroBundle:Producto:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PresisRetiroBundle:Producto')->find($id);
        ...
        return $this->render('PresisRetiroBundle:Producto:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PresisRetiroBundle:Producto:edit.html.twig', array(
            'entity'      => $entity,
