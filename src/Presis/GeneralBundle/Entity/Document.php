 ...
 * @ORM\Entity(repositoryClass="Presis\GeneralBundle\Entity\DocumentRepository")
...
class Document
{
    ...
    private $file;
    /**
     * @ORM\ManyToOne(targetEntity="Presis\GeneralBundle\Entity\Cliente",cascade={"remove"})
